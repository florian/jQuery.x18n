...
(function() {
  ...
  $.fn.x18n = function() {
    $("[data-" + config.key + "]").each(function() {
      var $this, interpolation, key, n, _base;
      $this = $(this);
      key = $this.attr("data-" + config.key);
      interpolation = $this.attr("data-" + config.interpolation) || '[]';
      n = $this.attr("data-" + config.plural);
      return typeof (_base = $this.t.apply($this, [key].concat(__slice.call(JSON.parse(interpolation))))).plural === "function" ? _base.plural(n) : void 0;
    });
    return this;
  };
