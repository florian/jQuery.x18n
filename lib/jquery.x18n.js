...
(function() {
  ...
  $.fn.t = function(key, interpolation) {
    var $this, k, tr, v, _results, _results1;
    $this = $(this);
    ...
    if ($.isPlainObject(tr)) {
      ...
      if ($.isPlainObject(interpolation)) {
        ...
        for (k in interpolation) {
          v = interpolation[k];
          _results.push($this.data("interpolation-" + k, v));
        }
        return _results;
      } else {
        _results1 = [];
        for (k in interpolation) {
          v = interpolation[k];
          _results1.push($this.data("interpolation-" + k, v));
        }
        return _results1;
      }
    }
  ...
  $.fn.x18n = function() {
    ...
    return $elements.each(function() {
      var $this;
      $this = $(this);
      return $this.html(t($this.data(config.key)));
    });
  };
