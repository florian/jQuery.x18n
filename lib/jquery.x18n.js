...
(function() {
  ...
  x18n = (function() {
    ...
    x18n.t = function(key, interpolation) {
      ...
      if (typeof tr === 'string') {
        tr = x18n.interpolate(tr, interpolation);
      } else if (tr !== void 0) {
...
(function() {
  ...
  $.fn.t = function() {
    var interpolation, key;
    key = arguments[0], interpolation = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return this.each(function() {
      var $this, k, tr, v, _results;
      $this = $(this);
      tr = t.apply(null, [key].concat(__slice.call(interpolation)));
      if ($.isPlainObject(tr)) {
        return tr.plural = $.x18n.plural;
      } else {
        $this.html(tr).attr("data-" + config.key, key);
        if ($.isPlainObject(interpolation[0])) {
          interpolation = interpolation[0];
        }
        _results = [];
        for (k in interpolation) {
          v = interpolation[k];
          _results.push($this.attr("data-interpolation-" + k, v));
        }
        return _results;
      }
    });
  ...
  $.fn.x18n = function() {
    var $elements;
    $elements = $('[data-t]', this);
    return $elements.each(function() {
      var $this, attributes, interpolation;
      $this = $this;
      interpolation = {};
      attributes = this.attributes;
      interpolation = $.grep($.makeArray(attributes), function(v) {
        return v.nodeName.indexOf('data-interpolation-') === 0;
      });
      interpolation = $.map(interpolation, function() {});
      console.log(interpolation);
      return $(this).html(t($(this).data(config.key)), interpolation);
    });
  };
